...
static int whep_read_header(AVFormatContext* avctx)
{
    ...
    webrtc_init_logger();
    webrtc_init_connection(&ctx->data_channel);
    ...
    track_init.codec = RTC_CODEC_H264; // TODO: support more codecs
    ...
    memset(&track_init, 0, sizeof(rtcTrackInit));
    track_init.direction = RTC_DIRECTION_RECVONLY;
    track_init.codec = RTC_CODEC_OPUS; // TODO: support more codecs
